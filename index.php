    ...
    <div class="contents">
      ...
      <section class="content content-home flex">
        <div>
          ...
          <p>専門学校で、Webの勉強をしている、三木 百花 と申します。<br>私のポートフォリオサイトにお越し下さり、ありがとうございます♪
          </p>
          <h3>What I have in mind</h3>
          <p>私は、<strong>相手の立場や気持ち</strong>になって、考えることを心がけています。</p>
          <ul>
            <li>相手の課題を研究し、アイデアを考え、実際につくる。</li>
            <li>効率的に綺麗でまとまったコードを書く。</li>
          </ul>
          <p>将来は、考えやコーディングにこだわりを持って、<br>周りの人を幸せにできるようなフロントエンドのエンジニアになりたいです。</p>
        </div>
      ...
      <section class="content content-history">
        ...
        <ul>
          <li class="flex">
            <p>2011〜2013</p>
            <div>
              <h3>Junior&nbsp;high&nbsp;school&nbsp;days</h3>
              <p>中学校3年間は吹奏楽部に所属。パートリーダーも任されました。<br>この時は、自分のWindowsのパソコンでよく遊んでいました。</p>
            </div>
          </li>
          <li class="flex">
            <p>2014〜2016</p>
            <div>
              <h3>High&nbsp;school&nbsp;days</h3>
              <p>大阪ビジネスフロンティアという商業高校に通っていました。
          ...
          <li class="flex">
            <p>2017</p>
            <div>
              <h3>ECC&nbsp;computer&nbsp;college&nbsp;year1</h3>
              <p>前半は、グラフィックデザイン・Webデザイン・コーディングを全体的に学びました。<br>
          ...
          <li class="flex">
            <p>2018</p>
            <div>
              <h3>ECC&nbsp;computer&nbsp;college&nbsp;year2</h3>
              <p>２年生になり制作して行く中で、自分がバックエンドよりもフロントエンドの方が得意で、好きだということが分かりました。<br>
          ...
          <li class="flex">
            <p>2019</p>
            <div>
              <h3>ECC&nbsp;computer&nbsp;college&nbsp;year3</h3>
              <p>3年生になって、WEB制作会社でアルバイトを始めました。<br>
      ...
      <section class="content content-contact">
        ...
        <div>
          ...
          <p><a href="https://github.com/MomokaMiki/"><i class="fab fa-github"></i><span>github</span></a></p>
        </div>
      </section>
    </div>
  </main>
